        ...
        <div class="grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
            @foreach($articles as $article)
                <article class="max-w-xs">
                    ...
                    <p class="mb-4 text-gray-500 dark:text-gray-400">{{ $article->body }}</p>
                    <a href="http://127.0.0.1:8000/articles/show/{{$article->id}}" class="inline-flex items-center font-medium underline underline-offset-4 text-primary-600 dark:text-primary-500 hover:no-underline">
                        Подробнее
                    </a>
                </article>
            @endforeach
